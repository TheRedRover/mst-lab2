...
public class SpeleologistAgent extends Agent {
    ...
    protected void setup() {
        ...
        System.out.println("Speleologist [" + getAID().getName() + "] is ready.");
    }

    @Override
    protected void takeDown() {
        System.out.println("Speleologist [" + getAID().getName() + "] terminating.");
    }
        ...
        public void action() {
            ...
            try {
                ...
                if (result != null && result.length > 0) {
                    ...
                    System.out.println("Speleologist [" + getAID().getName() + "]: Wumpus not found.");
                    block();
                }
                isDone = true;
                ...
                case 1:
                    ...
                    if (reply != null) {
                        if (reply.getPerformative() == ACLMessage.CONFIRM) {
                            System.out.println("Speleologist[" + getAID().getName() + "]: Wumpus world detected.");
        ...
        public void action() {
            switch (step) {
                case 0:
                    ...
                    System.out.println("Speleologist [" + getAID().getName() + "]: " + WumpusWorldAgent.Constants.ADVICE_PROPOSAL);
                    myAgent.send(inform);
                    ...
                    if (reply != null) {
                        if (reply.getPerformative() == ACLMessage.REQUEST) {
                            if (parseNavigatorMessageRequest(reply.getContent())) {
                                ...
                                System.out.println("Speleologist [" + getAID().getName() + "]: Unknown command");
                        }
                    } else {
                ...
                case 2:
                    ...
                    if (reply != null) {
                        if (reply.getPerformative() == ACLMessage.INFORM) {
                            ...
                            System.out.println("Speleologist [" + getAID().getName() + "]: " + WumpusWorldAgent.Constants.INFORMATION_PROPOSAL_SPELEOLOGIST + rep);
                            myAgent.send(mes);
                            mt = MessageTemplate.and(MessageTemplate.MatchConversationId(WumpusWorldAgent.Constants.NAVIGATOR_DIGGER_CONVERSATION_ID),
                        ...
                        if (reply.getPerformative() == ACLMessage.PROPOSE) {
                            ...
                            switch (action) {
                                ...
                                case Commands.CLIMB:
                                    ...
                                    break;
                                default:
                                    System.out.println("Speleologist [" + getAID().getName() + "]: No actions are available");
                                    break;
                            }
                    ...
                    if (reply != null) {
                        ...
                        switch (answer) {
                            case WumpusWorldAgent.Constants.FAIL_MESSAGE:
                                System.out.println("Speleologist [" + getAID().getName() + "]: DEAD.");
                                step++;
                                doDelete();
                                break;
                            case WumpusWorldAgent.Constants.OK_MESSAGE:
                                System.out.println("Speleologist [" + getAID().getName() + "]: Wumpus world answers OK.");
                                step = 0;
                                break;
                            case WumpusWorldAgent.Constants.WIN_MESSAGE:
                                System.out.println("Speleologist [" + getAID().getName() + "]: Victory");
                                step++;
                                doDelete();
                                break;
                        }
